...
public class Camera : MonoBehaviour
{
    ...
    public float displacament;
    public float iniCamPosFrame;
    public float nextCamPosFrame;
    void Update()
    {
    ...
    void LateUpdate()
    {
        ...
        bg2.position = new Vector3(bg2.position.x + (nextCamPosFrame - iniCamPosFrame) * factor2, bg0.position.y, bg2.position.z);
    }
}
